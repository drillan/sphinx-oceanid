...
- **sphinx-revealjs 対応** — IntersectionObserver による非表示スライドの遅延レンダリング（[サンプル](https://drillan.github.io/sphinx-oceanid/slides/)）
...
ビルドしてプレビュー — Mermaid ダイアグラムの表示には HTTP サーバーが必要です（`file://` では CORS 制限によりレンダリングされません）：
...
詳細なドキュメントは **[drillan.github.io/sphinx-oceanid](https://drillan.github.io/sphinx-oceanid/)** または [docs/](docs/) ディレクトリを参照してください。
